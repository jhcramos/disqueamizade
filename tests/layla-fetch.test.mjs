...
test('Layla has a named primary throw action and returns the only ball to its thrower',()=>{
 assert.equal(NAMES.biscoito,'Layla');const s=createLife(10000),v={id:'ana',name:'Ana',position:{...ITEMS.toy.position}},other={id:'bruno',name:'Bruno',position:{x:-7,z:2.7}};s.residents[2].position={x:ITEMS.toy.position.x+.7,z:ITEMS.toy.position.z};
