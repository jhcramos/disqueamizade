...
const STARTER_PLAYLISTS: Record<string, Video[]> = {
  default: [
    { id: 'kDMHHuUqL0w', title: 'Aquarela', artist: 'Toquinho' },
    { id: 'UJkxFhFRFDA', title: 'Garota de Ipanema', artist: 'Tom Jobim & Vinícius' },
    { id: '2LGQ_aurRjM', title: 'Evidências', artist: 'Chitãozinho & Xororó' },
    { id: 'hcm55lU9knw', title: 'Mas Que Nada', artist: 'Sergio Mendes' },
    { id: 'KzGKsXNVAVw', title: 'Anunciação', artist: 'Alceu Valença' },
    { id: 'SeBjr6Gmweo', title: 'Pais e Filhos', artist: 'Legião Urbana' },
    { id: 'A-J1gSKGBss', title: 'Fico Assim Sem Você', artist: 'Adriana Calcanhotto' },
    { id: '4F83UrXoL6c', title: 'Trem das Onze', artist: 'Adoniran Barbosa' },
  ],
  drinks: [
    { id: 'ePjtnSPFWK8', title: 'Cerveja', artist: 'Skank' },
    { id: 'xG0wi1m-89o', title: 'Não Deixe o Samba Morrer', artist: 'Alcione' },
    { id: 'moFk3bwSOOo', title: 'Que País É Este', artist: 'Legião Urbana' },
  ],
  cities: [
    { id: '8AqTfWPqQKA', title: 'Sampa', artist: 'Caetano Veloso' },
    { id: 'OfEJXfONjVs', title: 'Eduardo e Mônica', artist: 'Legião Urbana' },
    { id: 'E1tOV7y94DY', title: 'Pela Internet', artist: 'Gilberto Gil' },
  ],
  interests: [
    { id: 'YR5ApYxkU-U', title: 'Another Brick in the Wall', artist: 'Pink Floyd' },
